...
// SHARED module (jetbrains/common/src/main/resources/webview/), so BOTH the
// DevEco Studio and IntelliJ flavors pick it up from one place. Run after
// build:webview. Mirrors scripts/copy-vs-assets.mjs.
